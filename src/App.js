...
function App() {
  ...
  function handleGenerate() {
    alert(`Generating plan for ${formData.city} — ${formData.duration} — ₹${formData.budget}`);
  }
  ...
  const s = {
    ...
    toggleBtn: { backgroundColor: d ? "#222" : "#333", color: "#fff", border: "none", borderRadius: "20px", padding: "8px 18px", fontSize: "13px", cursor: "pointer", whiteSpace: "nowrap", marginTop: "8px" },
    body: { padding: "32px 40px" },
    card: { maxWidth: "860px", backgroundColor: d ? "#1a1a1a" : "#ffffff", borderRadius: "16px", padding: "32px", border: `1px solid ${d ? "#2a2a2a" : "#e0e0e0"}`, boxShadow: d ? "none" : "0 2px 12px rgba(0,0,0,0.08)" },
    ...
    generateBtn: { marginTop: "24px", backgroundColor: "#3b82f6", color: "#fff", border: "none", borderRadius: "8px", padding: "12px 28px", fontSize: "15px", fontWeight: "600", cursor: "pointer" },
  };
